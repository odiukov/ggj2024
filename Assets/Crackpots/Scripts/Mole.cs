...
{
    [Header("Graphics")] [SerializeField] private Sprite mole;
    ...
    private GameManagerCrackpots gameManager;

    // The offset of the sprite to hide it.
    private Vector2 startPosition = new Vector2(0f, -2.56f);
    public Vector2 startPositionBack = new Vector2(0f, -2.56f);
    private Vector2 endPosition = Vector2.zero;

    public Vector2 endPositionBack = Vector2.zero;
    ...
    private IEnumerator ShowHide(Vector2 start, Vector2 end)
    {
        ...
        back.transform.localPosition = startPositionBack;
        ...
        while (elapsed < showDuration)
        {
            ...
            back.transform.localPosition = Vector2.Lerp(startPositionBack, endPositionBack, elapsed / showDuration);
        ...
        back.transform.localPosition = endPositionBack;
        ...
        while (elapsed < showDuration)
        {
            ...
            back.transform.localPosition = Vector2.Lerp(endPositionBack, startPositionBack, elapsed / showDuration);
